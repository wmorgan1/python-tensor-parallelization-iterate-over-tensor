...
def main():
    ...
    if len(sys.argv) < 3:
        print("python testMake2.py <output filename> <size> <standard deviation> <# of rank 1 tensors> <lambda1>")
        sys.exit()
    ...
    sd = float(sys.argv[3])
    distance = 0
    numTens = int(sys.argv[4])
    print(numTens)
    lambdaList = [float(sys.argv[5])]
